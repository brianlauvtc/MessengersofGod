...
public class fire_mission1 : MonoBehaviour
{
    public bool accept;
    public bool done;
    ...
    void Update()
    {
        ...
        accept = player.scenefire_m1_accept;
        done = player.scenefire_m1;
        finish = player.scenefire_m1_finish;
            ...
            if (accept == true)
        {
            ...
            missionlable.text = "Talk to town head - Jarvis";
            if (finish == true)
