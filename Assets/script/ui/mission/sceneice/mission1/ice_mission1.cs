...
public class ice_mission1 : MonoBehaviour
{
    public bool accept;
    public bool done;
    Camera main_camera;
    ...
    void Update()
    {
        ...
        accept = player.sceneice_m1_accept;
        done = player.sceneice_m1;
        finish = player.sceneice_m1_finish;
            ...
            if (accept == true)
        {
            ...
            missionlable.text = "Talk to town head - Verne";
            if (finish == true)
