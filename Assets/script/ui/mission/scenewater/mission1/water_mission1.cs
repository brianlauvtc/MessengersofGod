...
public class water_mission1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        accept = player.scenewater_m1_accept;
        done = player.scenewater_m1;
        finish = player.scenewater_m1_finish;
            ...
            if (accept == true)
        {
            ...
            missionlable.text = "Talk to town head - Abner";
            if (finish == true)
