...
{   
  ...
  //  public CanvasGroup black_cg;
    ...
    void Start()
    {
        ...
        dialogue[10] = "Two years later, a giant meteorite fell on Pluto.";
        dialogue[11] = "This meteorite caused a big bang and a big earthquake.";
        dialogue[12] = "Because the town was built with high technology";
        dialogue[13] = "The buildings here were not damaged by the explosion and the earthquake.";
        dialogue[14] = "But the impact of the explosion kept the four crystals away from their original positions.";
        dialogue[15] = "Because of the crystal separated, the crystal become a big monster to wreak havoc.";
        dialogue[16] = "Shengwang Town sent a lot of soldiers to fight the big monsters";
        dialogue[17] = "But the big monsters summon some little monster to killing soldiers";
        dialogue[18] = "Anaki is selecting one of hero to go to Pluto to solve the problem.";
