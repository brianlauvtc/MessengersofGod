...
public class Fire_CheckOpen : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (player.scenefire_m1 == true && player.scenefire_m2 == true && player.scenefire_m3 == true && player.scenefire_m4 == true && player.scenefire_m5 == true && player.scenefire_m6 == true)
        {
