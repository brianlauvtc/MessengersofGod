...
public class Warrior_skill_3 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            if (Input.GetKeyDown(KeyCode.E) && !Input.GetKey(KeyCode.Space) && !Input.GetKey(KeyCode.LeftShift) && !Input.GetKey(KeyCode.W) && !Input.GetKey(KeyCode.R) && !Input.GetKey(KeyCode.Q))
            {
        ...
        if (animator.GetBool("skill3") == true)
        { check(); }
